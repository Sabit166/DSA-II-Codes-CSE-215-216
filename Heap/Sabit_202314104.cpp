...
public:
    ...
    int find_max_update(char *A, int idx)
    {
        ...
        if (l > size_ && r > size_)
            return -1;
        if (l <= size_ && string(heap[l].name) == string(A))
            return l;
        if (r <= size_ && string(heap[r].name) == string(A))
            return r;
    ...
    {
        if (string(heapmn[idx].name) == string(A))
            return idx;
        int l = 2 * idx;
        int r = 2 * idx + 1;
        if (l > size_ && r > size_)
            return -1;
        if (l <= size_ && string(heapmn[l].name) == string(A))
            return l;
        if (r <= size_ && string(heapmn[r].name) == string(A))
            return r;
